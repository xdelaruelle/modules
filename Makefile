...
ifeq ($(nagelfaraddons),y)
	...
	$(INSTALL_DATA) contrib/nagelfar/plugin_modulecache.tcl  '$(DESTDIR)$(nagelfardatadir)/'
	...
	$(INSTALL_DATA) contrib/nagelfar/syntaxdb_modulecache.tcl  '$(DESTDIR)$(nagelfardatadir)/'
