...
AC_DEFUN([EM_SET_TCL], [
	AC_ARG_WITH(tcl-ver,
	AS_HELP_STRING([--with-tcl-ver=X.Y],
	...
	AC_ARG_WITH(tcl-inc,
	AS_HELP_STRING([--with-tcl-inc=<dir>],
...
AC_DEFUN([EM_SET_TCLX], [
	...
	AS_HELP_STRING([--with-tclx-ver=X.Y],
	...
	AS_HELP_STRING([--with-tclx-lib=<dir>],
	...
	AS_HELP_STRING([--with-tclx-inc=<dir>],
