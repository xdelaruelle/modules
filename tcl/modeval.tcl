...
proc saveLoadedReqOfReloadingModuleList {reload_mod_list unload_mod_list} {
   ...
   foreach reload_mod $reload_mod_list {
      if {![info exists ::g_savedLoReqOfReloadMod($reload_mod)]} {
         set ::g_savedLoReqOfReloadMod($reload_mod)\
            [getRequiredLoadedModuleList [list $reload_mod] $unload_mod_list]
      }
   }
}
